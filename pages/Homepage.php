...
<head>
    ...
    <title> Agora</title>
    <link href="/qna/static/main.css" rel="stylesheet">
    <link href="/qna/static/images/logo.png" rel="icon">
</head>
...
<body>
    ...
    <div class="container">
        <header>
            <div class="logo">
                <img src="/qna/static/images/logo5.png" class="logo">
            </div>
            <div clas="agora">
                <h1 class="agora"> Agora </h1>
            </div>
            <div class="uicon">
                <img src="/qna/static/images/uicon.png" class="uicon" float="left">
